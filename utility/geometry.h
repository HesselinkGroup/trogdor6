...
/**
 * True if triangles are coplanar and intersecting.
 * If relTol > 0, triangles that don't intersect might sometimes be marked intersecting.
 * If relTol < 0, triangles with intersecting edges might sometimes be marked non-intersecting.
 */
template<typename T>
